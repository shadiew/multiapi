...
<head>
    ...
    <link rel="shortcut icon" href="<?php echo $cfg_baseurl; ?>/assets/images/logo/favicon.svg" type="image/x-icon">
    <link rel="shortcut icon" href="<?php echo $cfg_baseurl; ?>/assets/images/logo/favicon.png" type="image/png">
...
<body>
    ...
    <div class="sidebar-header position-relative">
        <div class="d-flex justify-content-between align-items-center">
            <div class="logo">
                <a href="index.html"><img src="<?php echo $cfg_baseurl; ?>/assets/images/logo/logo.svg" alt="Logo" srcset=""></a>
            </div>
