...
<head>
    ...
    <title><?php echo $data_settings['web_name']; ?> | Kategori Sosial Media</title>
    ...
    <div class="page-title">
        <div class="row">
            <div class="col-12 col-md-6 order-md-1 order-last">
                <h3>Kategori Sosmed</h3>
                <a href="add_sosmed" class="btn icon icon-left btn-primary btn-sm"><i data-feather="plus"></i> Tambah Kategori</a>
            ...
            <div class="col-12 col-md-6 order-md-2 order-first">
                <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Kategori Layanan Sosmed</li>
                    </ol>
                </nav>
            </div>
        </div>
                ...
                <table class="table table-striped" id="table1">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="edit_kategori.php?sid=<?php echo $data_show['sid']; ?>" class="btn icon btn-primary btn-sm"><i class="bi bi-pencil"></i></a>
                                <a href="delete_kategori.php?sid=<?php echo $data_show['sid']; ?>" class="btn icon btn-danger btn-sm"><i class="bi bi-trash2"></i></a>
                            </td>
                        </tr>
                        <?php
                            }
