...
<body class="has-navbar-vertical-aside navbar-vertical-aside-show-xl   footer-offset">
        ...
        <div class="col-lg-12 mb-3 mb-lg-0">
          ...
          <div class="card mb-3 mb-lg-5">
            ...
            <div class="card-body">
              ...
              <!-- Form -->
              <div class="mb-4">
                <label for="productNameLabel" class="form-label">Nama Lengkap <i class="bi-question-circle text-body ms-1" data-bs-toggle="tooltip" data-bs-placement="top" title="Isi sesuai nama lengkap user atau member anda."></i></label>
        ...
        <div class="modal-body">
          ...
          <div class="d-flex">
            <div class="flex-shrink-0 mb-3 mb-sm-0">
              <img class="avatar avatar-lg avatar-4x3" src="../../themes/assets/svg/illustrations/oc-money-profits.svg" alt="Image Description" data-hs-theme-appearance="default">
              <img class="avatar avatar-lg avatar-4x3" src="../../themes/assets/svg/illustrations-light/oc-money-profits.svg" alt="Image Description" data-hs-theme-appearance="dark">
            </div>
          ...
          <div class="d-flex">
            <div class="flex-shrink-0 mb-3 mb-sm-0">
              <img class="avatar avatar-lg avatar-4x3" src="../../themes/assets/svg/illustrations/oc-discount.svg" alt="Image Description" data-hs-theme-appearance="default">
              <img class="avatar avatar-lg avatar-4x3" src="../../themes/assets/svg/illustrations-light/oc-discount.svg" alt="Image Description" data-hs-theme-appearance="dark">
            </div>
          ...
          <div class="d-flex">
            <div class="flex-shrink-0 mb-3 mb-sm-0">
              <img class="avatar avatar-lg avatar-4x3" src="../../themes/assets/svg/illustrations/oc-collection.svg" alt="Image Description" data-hs-theme-appearance="default">
              <img class="avatar avatar-lg avatar-4x3" src="../../themes/assets/svg/illustrations-light/oc-collection.svg" alt="Image Description" data-hs-theme-appearance="dark">
            </div>
  ...
  <script src="../../themes/assets/vendor/hs-quantity-counter/dist/hs-quantity-counter.min.js"></script>
  <script src="../../themes/assets/vendor/hs-add-field/dist/hs-add-field.min.js"></script>
  ...
  <script src="../../themes/assets/vendor/datatables/media/js/jquery.dataTables.min.js"></script>
  <script src="../../themes/assets/vendor/datatables.net.extensions/select/select.min.js"></script>
